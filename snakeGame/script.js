...
function startGame() {
    ...
    changeDirection = () => {
        ...
        snake.forEach((cur, index) => {
            ...
            // console.log(mySel("table").children[0].children[cur[0]].children[cur[1]]);

            // mySelAll(".active")[index].style.background = "blue"
        })
...
// file:///home/bhavesh-rathod/Desktop/bh/JS/snake/index.html
